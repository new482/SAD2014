...
public class OrderPersistenceTests {
	...
	@Test
	@Transactional
	public void testSelectOffice() throws Exception{
		Office office = new Office();
		Nominee nominee = new Nominee();
		
		nominee.setName("test");
		nominee.setEmail("testemail");
		office.addNominee(nominee);
		entityManager.persist(nominee);
		entityManager.persist(office);
		
		assertNotNull(office.getNominee());
	}
